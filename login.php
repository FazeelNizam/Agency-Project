...
<script> // script for get alert massege and redirrect to the target page 
	$(function(){
		$('#login').click(function(e){ // function to be called after clicking login button
			...
			$.ajax({
				...
				success: function(data){
					...
					if($.trim(data) === "Loged in successfully"){
